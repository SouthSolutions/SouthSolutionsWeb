  ...
  return (
    <section>
      <div
        ...
        <h1 className="text-3xl md:text-4xl lg:text-4xl text-white text-center">SouthSolutions Tech</h1>
        <hr />
        <h2
          style={{ fontFamily: "monospace" }}
          className=" text-2xl  md:text-3xl lg:text-3xl text-white text-center transition-all duration-[1s] mt-6"
          id="typed"></h2>
      </div>
    </section>
  );
